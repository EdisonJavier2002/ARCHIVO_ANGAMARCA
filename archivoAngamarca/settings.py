"""
Django settings for archivoAngamarca project.
...
SECRET_KEY = 'django-insecure-q25-y7u92pf#ba1v=-if=n@jg3j!9@kabjq=_9n6*@@9-or4e='
...
ROOT_URLCONF = 'archivoAngamarca.urls'
...
WSGI_APPLICATION = 'archivoAngamarca.wsgi.application'
...
STATIC_URL = 'static/'
STATICFILES_DIRS= (os.path.join(BASE_DIR, 'archivoAngamarca/static'),)
